...
export const technicalSkills = [
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" className="w-8 h-8">
        <defs>
          <linearGradient id="swift-gradient" x1="0%" y1="0%" x2="100%" y2="100%" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#f88535" />
            <stop offset="100%" stopColor="#fd2221" />
          </linearGradient>
        </defs>
        <path
